...
//
// Function     : error_msg
// Description  : Log a message to the arpsec deamon log (exactly the same as asLogMessage)
//
// Inputs       : fmt - the log data format
//                ... - the arguments themselves
// Outputs      : void
// NOTE		: This function is needed by the pcap source code ported from TARP.
